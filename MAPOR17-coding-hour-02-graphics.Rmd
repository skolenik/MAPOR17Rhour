...
MAPOR 2017 Coding Hour: Base Graphics
=====================================
...
```{r}
Barchart(Gender, by=ShoeBin, data=dataBodyMeas)
```
...
dataBodyMeas$ShoeBin4 <- with(dataBodyMeas, bin.var(Shoe, bins=4, 
  method='proportions', labels=NULL))
dataBodyMeasSum <- as.data.frame(table(dataBodyMeas$ShoeBin4,dataBodyMeas$Gender))
...
ScatterPlot(Gender,ShoeBin4,data=dataBodyMeasSum,size=Freq,shape="sunflower")
